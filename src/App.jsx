...
export default function App() {
  ...
  const compareAtPrice = selectedSize.salePrice != null ? selectedSize.price : null;
  const unitPrice = selectedSize.salePrice != null ? selectedSize.salePrice : selectedSize.price;
  ...
  // Each of shipping / delivery / payment = 33% of the top progress line
  const stepsDone =
  ...
  const draftUnitPrice = draftSize.salePrice != null ? draftSize.salePrice : draftSize.price;
  ...
  function confirmDelivery() {
    if (deliveryMode === 'pickup') {
      ...
      const dateLabel = selectedDate
        ...
        : '';
      setDeliveryStatus(
        `${pickupChosen.name} · ${dateLabel}, ${selectedTime}`,
      );
    } else {
  ...
  function finishCheckoutLoader() {
    // Keep black loader + overlay on while the cart drawer slides closed
    setSheet(null);
    ...
    <>
      ...
      <header className="site-header">
        <div className="site-header__row">
          ...
          <a href="#" className="site-logo" aria-label="KEEN">
            <img src={brand.logoSrc} alt="KEEN" />
          </a>
      ...
      <div className={`mobile-menu${menuOpen ? ' is-open' : ''}`}>
        <div className="mobile-menu__body">
          ...
          <nav className="mobile-menu__nav">
            <a href="#" className="mobile-menu__nav-main">men</a>
            <a href="#" className="mobile-menu__nav-main">women</a>
            <a href="#" className="mobile-menu__nav-main">kids</a>
          </nav>
        </div>
      </div>
      ...
      >
        ...
        <div className="cart-drawer__body">
          {inCart ? (
            <div className="cart-item cart-item--ov">
              ...
              <div className="cart-item__info">
                <div className="cart-item__top">
                  ...
                  <div className="cart-item__price-wrap">
                    <div className="cart-item__price-line">
                      {compareAtPrice != null && (
                        <span className="cart-item__price cart-item__price--was">
                          ${(compareAtPrice * qty).toFixed(2)}
                        </span>
                      )}
                      <span className="cart-item__price">${(unitPrice * qty).toFixed(2)}</span>
                    </div>
                    {compareAtPrice != null && (
                      <span className="cart-item__sale-tag">Final sale</span>
                    )}
                  </div>
                </div>
                ...
                <div className="cart-item__controls">
                    ...
                    {qty <= 1 ? (
                      ...
                      >
                        <svg width="14" height="16" viewBox="0 0 16 18" fill="none" aria-hidden="true">
                          <path
                            d="M1 4h14M6 1h4M3 4l1 13h8l1-13M6.5 7.5v6M9.5 7.5v6"
                            stroke="#111111"
                            strokeWidth="1.3"
                            strokeLinecap="round"
                  ...
                  <button
                    ...
                    onClick={openPdpSheet}
                    aria-label={`Size ${selectedSize.label}`}
                  >
                    {selectedSize.label}
                    <span className="cart-control__chevron" aria-hidden="true">
                      ▾
                    </span>
                  </button>
                </div>
            ...
            <p className="body-text" style={{ paddingTop: 8 }}>Your bag is empty</p>
          )}
        </div>
        ...
        <div
          ref={checkoutFlowRef}
          className={`checkout-flow${sheet ? ' is-open' : ''}${sheet ? ` checkout-flow--${sheet}` : ''}`}
        >
          <SheetFeedback
            type={sheetFeedback}
          ...
          <div className={`checkout-sheet checkout-sheet--pdp${sheet === 'pdp' ? ' is-active' : ''}`}>
            ...
            <div className="pdp-sheet__body">
              ...
              <div className="pdp-sheet__section">
                ...
                <p className="pdp-sheet__row-preview" style={{ marginTop: 8 }}>
                  {draftColor.label}
                </p>
              </div>
                ...
                <div className="pdp-sheet__options">
                  {product.sizes.map((s) => (
                    <button
                      key={s.id}
                      type="button"
                      className={`pdp-option pdp-option--size${draftSizeId === s.id ? ' is-active' : ''}`}
          ...
          <div className={`checkout-sheet checkout-sheet--pinned${sheet === 'verify' ? ' is-active' : ''}`}>
            ...
            <div className="checkout-sheet__scroll">
              <div className="checkout-sheet__brand checkout-sheet__brand--logo">
                <img src={brand.logoSrc} alt={brand.name} />
              </div>
      ...
      <section className="product-section">
        ...
        <div className="product-info">
          ...
          <div className="product-attrs product-attrs--sizes">
            <p className="product-attrs__label">Size</p>
            <div className="pdp-sheet__options pdp-sheet__options--sizes">
              {product.sizes.map((s) => (
                <button
                  key={s.id}
                  type="button"
                  className={`pdp-option pdp-option--size${sizeId === s.id ? ' is-active' : ''}`}
          ...
          <div className="purchase-options">
            <p className="checkout-label" style={{ marginBottom: 10 }}>Color — {selectedColor.label}</p>
            <div className="pdp-sheet__options" style={{ marginBottom: 16 }}>
              {product.colors.map((c) => (
                <button
                  key={c.id}
                  type="button"
