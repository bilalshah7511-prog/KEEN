...
// lottie-react CJS/ESM interop — default can be nested
const Lottie =
...
/**
 * Drawer checkout overlay — video flow without CSS spinner:
 * BG+logo → Lottie check → close
 */
